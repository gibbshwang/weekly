...
const faqs = [
  ...
  {
    q: "MOODEX는 투자 권유 서비스인가요?",
    a: "아닙니다. MOODEX는 시장 심리 정보를 제공하는 정보 서비스입니다. 투자 결정은 본인의 판단과 책임 하에 이루어져야 합니다.",
  },
  {
    q: "결제 수단은 무엇을 지원하나요?",
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col gap-8">
      <div className="text-center">
        <h1 className="text-3xl font-black text-white">MOODEX PRO</h1>
      ...
      <div className="p-4 bg-gray-800/30 rounded-xl border border-gray-800">
        <p className="text-xs text-gray-600 leading-relaxed text-center">
          MOODEX PRO는 투자 자문 서비스가 아닙니다. 모든 정보는 교육 및 정보 제공 목적이며,
