...
export const interpretations: Record<Regime, {
  ...
  extreme_fear: {
    ...
    drivingFactors: "VIX 급등 및 안전자산으로의 급격한 자금 이동이 주된 원인입니다.",
    usagePoints: [
      "과거 유사 구간에서는 분할 매수 전략이 일반적으로 고려되어 왔습니다",
      "단기 반등 가능성이 높아지는 시점이지만, 추세 반전 확인이 중요합니다",
      "포트폴리오 리밸런싱을 검토하기에 적합한 시점일 수 있습니다",
    ],
    watchFor: ["VIX 30 이하 안정화", "S&P 500 125일 이평선 회복", "HYG/LQD 스프레드 축소"],
  },
  fear: {
    label: "공포",
    color: "#ef4444",
    ...
    watchFor: ["S&P 500 125일 이평선 회복 시도", "VIX 20 이하 안정", "외국인 순매수 전환"],
  },
  neutral: {
    label: "중립",
    color: "#6b7280",
    ...
    watchFor: ["지수 방향성 확인", "외국인/기관 수급 변화", "VIX 방향성"],
  },
  greed: {
    label: "탐욕",
    color: "#22c55e",
    ...
    watchFor: ["80 이상 극단적 탐욕 진입 여부", "S&P 500 과열 지표 확인", "국채 금리 급등 여부"],
  },
  extreme_greed: {
    label: "극단적 탐욕",
    color: "#d97706",
    ...
    watchFor: ["VIX 급등 신호", "S&P 500 이평선 이탈 여부", "정크본드 스프레드 확대"],
  },
};
